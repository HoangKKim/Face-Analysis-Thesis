...
if __name__ == '__main__':
    ...
    parser.add_argument('--data', type=str, default='data/JointBP_CrowdHuman_face.yaml')
    ...
    detected_objs = detector(args.img_path, args.data, args.weights, args.imgsz, args.device, args.conf_thres, args.iou_thres, args.match_iou, args.scales, args.line_thick, args.counting)
    # save in json 
    print('--'*20)
    print(detected_objs)
    print('--'*20)
