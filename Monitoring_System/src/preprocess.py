...
class FacePreprocessor:
    ...
    def __init__(self, predictor_path='shape_predictor_68_face_landmarks.dat'):
        ...
        try:
            ...
            print("✅ Face alignment enabled with dlib predictor")
        except:
            self.face_alignment_enabled = False
            print("⚠️ Face alignment disabled - predictor not found")
    ...
    def enhance_face_alignment(self, image, desired_face_width=224, desired_left_eye=(0.35, 0.35)):
        ...
        if not self.face_alignment_enabled:
            return cv2.resize(image, (desired_face_width, desired_face_width))
